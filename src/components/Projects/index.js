      ...
      >
              ...
              <div className="card overflow-hidden h-full flex flex-col">
                ...
                <div className="p-4 sm:p-6 flex-1 flex flex-col">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-xs sm:text-sm text-primary-400 font-medium">{project.date}</span>
                    <span className="px-2 py-1 bg-primary-500/20 text-primary-400 text-xs rounded-full">
                      {project.category}
                    </span>
                  </div>

                  <h3 className="text-lg sm:text-xl font-bold text-white mb-3 group-hover:text-primary-400 transition-colors">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                    <motion.button
                      onClick={() => setOpenModal({ state: true, project })}
                      className="flex-1 btn-primary text-xs sm:text-sm py-2 px-3 sm:px-4"
                    ...
                    {project.webapp && (
                      <motion.a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="btn-secondary text-xs sm:text-sm py-2 px-3 sm:px-4 text-center"
                        whileHover={{ scale: 1.02 }}
                        whileTap={{ scale: 0.98 }}
                      >
                        Live Demo
        ...
        <motion.div className="text-center mt-8 sm:mt-12" variants={itemVariants}>
          <motion.a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn-secondary inline-flex items-center gap-2 text-sm sm:text-base px-4 py-3 sm:px-6 sm:py-3"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
